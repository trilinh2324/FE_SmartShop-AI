...
//     fetch(`http://localhost:8080/api/bill/${billId}`)
//         .then(res => res.json())
//         .then(data => {
//             if (data.paymentStatus === "PAID") {
//                 // Hiện thông báo thành công
//             } else {
//                 // Chờ thêm hoặc báo đang xử lý
//             }
//         });
// }, []);
...
//   // Lấy billId từ URL query (?billId=123) hoặc localStorage
...
//           <button
//             style={s.btnPrimary}
//             onClick={() => setActivePage && setActivePage("/user/home")}
//           >
//             🛒 TIẾP TỤC MUA HÀNG
//           </button>
//           <button
//             style={s.btnSecondary}
//             onClick={() => setActivePage && setActivePage("/user/profile")}
//           >
//             📦 XEM ĐƠN HÀNG
//           </button>
//         </div>
...
//   divider: { height:1, background:"linear-gradient(90deg,transparent,rgba(232,0,13,.3),transparent)", margin:"0 0" },
